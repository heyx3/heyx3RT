...
namespace RT.MaterialValue
{
	public static class ShaderGenerator
	{
											...
											MV_Base albedo, MV_Base metallic, MV_Base smoothness)
		{
			...
			Insert(shaderlabProperties, cgDefinitions, funcBody, albedo);
			Insert(shaderlabProperties, cgDefinitions, funcBody, metallic);
			Insert(shaderlabProperties, cgDefinitions, funcBody, smoothness);
	...
	Fallback ""Diffuse""
		...
		/// <summary>
		/// Sets the parameters of the given Unity material,
